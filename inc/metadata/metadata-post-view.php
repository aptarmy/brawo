 ...
 * To display post count view in theme use this code
	$meta_value = get_post_meta( $post_ID, 'brawo_post_views_count', true );
	if( !empty( $meta_value ) ) {
		echo $meta_value;
	}
 */
function brawo_metadata_post_views_count() {
	if (is_single()) {

		global $post;
		//Set the name of the Posts Custom Field.
		$count_key = 'brawo_post_views_count'; 
...
add_action('wp_head', 'brawo_metadata_post_views_count');