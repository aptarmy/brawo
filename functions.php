...
if ( ! function_exists( '_s_fonts_url' ) ) :
/**
 * Register Google fonts for _s.
 *
 * Create your own _s_fonts_url() function to override in a child theme.
 *
...
function _s_fonts_url() {
	...
	if ( 'off' !== _x( 'on', 'Montserrat font: on or off', '_s' ) ) {
		$fonts[] = 'Montserrat:400,700';
	}

	/* translators: If there are characters in your language that are not supported by Inconsolata, translate this to 'off'. Do not translate into your own language. */
	if ( 'off' !== _x( 'on', 'Inconsolata font: on or off', '_s' ) ) {
